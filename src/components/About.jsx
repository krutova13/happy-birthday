  ...
  return (
    ...
    >
      <div className="max-w-3xl mx-auto">
        <Countdown />
        <motion.h2
          className="text-5xl md:text-7xl font-eb-garamond md:font-creepster text-horror-red mb-12 text-center flicker"
        ...
        >
          ...
          <motion.a
            ...
            className="inline-block px-6 py-3 bg-horror-dark-red text-horror-white font-eb-garamond md:font-creepster text-lg rounded hover:bg-horror-red transition-colors duration-300 border border-horror-red"
